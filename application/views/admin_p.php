...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?php echo assets_url(); ?>images/banner/banner-administracao-publica.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">

			<div class="container clearfix">
				<h1><?php echo $this->lang->line('page_title'); ?></h1>
				<span><?php echo $this->lang->line('page_subtitle'); ?></span>
				<ol class="breadcrumb">
					<li><a href="inicio"><?php echo $this->lang->line('page_nav_link1'); ?></a></li>
					<li><a href="#"><?php echo $this->lang->line('page_nav_link2'); ?></a></li>
					<li class="active"><?php echo $this->lang->line('page_nav_text_route'); ?></li>
				</ol>
			</div>
		...
		<section id="content">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="heading-block bottommargin-sm">
								<h3><?php echo $this->lang->line('section2_title'); ?></h3>
							</div>

							<p class="nobottommargin"><?php echo $this->lang->line('section2_content1'); ?></p>
						</div>
			...
			<div class="container clearfix">
				...
				<div class="col_half topmargin-sm bottommargin">
					<img data-animate="fadeInLeftBig" src="<?php echo assets_url(); ?>images/contenido/administracao-1.png" alt="Imac">
				</div>

				<div class="col_half col_last topmargin-sm bottommargin-lg col_last">

					<div class="heading-block topmargin">
						<h2><?php echo $this->lang->line('section3_title'); ?></h2>
						<span><?php echo $this->lang->line('section3_subtitle'); ?></span>
					</div>

					<p><?php echo $this->lang->line('section3_content1'); ?></p>
					
					<p><?php echo $this->lang->line('section3_content2'); ?></p>
		...
		<section id="page-title" class="page-title-dark">
			<div class="container clearfix">
				<div class="col_half topmargin nobottommargin dark">
					...
					<h3><?php echo $this->lang->line('section4_title'); ?></h3>

					<p><?php echo $this->lang->line('section4_content1'); ?></p>
					
					<p><?php echo $this->lang->line('section4_content2'); ?></p>
					
					<p><?php echo $this->lang->line('section4_content3'); ?></p>
					
					<p><?php echo $this->lang->line('section4_content4'); ?></p>
				...
				<div class="col_half col_last topmargin nobottommargin">
					...
					<img src="<?php echo assets_url(); ?>images/contenido/administracao-2.png" alt="Macbook Video Underlay" data-animate="fadeInRightBig">
		...
		<section id="page-title" class="page-title-dark">
			<a class="button button-full center tright footer-stick">
				<div class="container clearfix">
					<?php echo $this->lang->line('section5_link_content1'); ?> <strong><?php echo $this->lang->line('section5_link_content2'); ?></strong> <i class="icon-caret-right" style="top:4px;"></i>
				</div>
			</a>
		</section><!-- #page-title end -->
