...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?php echo assets_url(); ?>images/banner/banner-mar.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">

			<div class="container clearfix">
				<h1>Mar & Crecimiento Azul'</h1>
				<span></span>
				<ol class="breadcrumb">
					<li><a href="#">Inicio</a></li>
					<li><a href="#">Mercados</a></li>
					<li class="active">Mar y Crecimiento Azul</li>
				</ol>
			</div>
		...
		<section id="content">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="heading-block bottommargin-sm">
								<h3>El Crecimiento Azul</h3>
							</div>

							<p class="nobottommargin">Creemos en el potencial de los mares, océanos y regiones costeras, así como de las industrias que los utilizan y explotan como impulsores de una nueva ola de prosperidad económica y social.</p>
						</div>
			...
			<div class="container clearfix">
				...
				<div class="col_half topmargin-sm bottommargin">
					<img data-animate="fadeInLeftBig" src="<?php echo assets_url(); ?>images/contenido/mar-1.png" alt="Imac">
				</div>

				<div class="col_half col_last topmargin-sm bottommargin-lg col_last">

					<div class="heading-block topmargin">
						<h2>ECONOMÍA DEL MAR</h2>
						<span></span>
					</div>

					<p>Somos conscientes de la importancia estratégica del sector tecnológico para la producción de conocimiento, cooperación técnica y capacitación para el desarrollo sostenible. Aceptamos, de esta forma, la misión de responder a este nuevo impulso de crecimiento económico basado en el componente marítimo, apalancado en el potencial de las diferentes actividades económicas con innovación tecnológica, contribuyendo de forma equilibrada al desarrollo de la economía, el bienestar de las personas y la preservación de su ecosistema.</p>
					
					<p>Con la apuesta BlueGrowth, PROIT Technologies y el Grupo COMPTA, asume su compromiso de contribuir en los objetivos del crecimiento económico inteligente, sostenible e inclusivo, preconizado en la Estrategia Europea de Crecimiento Azul (BlueGrowth) y que recientemente han sido eco global con la redefinición de los objetivos de desarrollo Sostenible trazado por las Naciones Unidas hacia el año 2030.</p>
		...
		<section id="page-title" class="page-title-dark">
			<div class="container clearfix">
				<div class="col_half topmargin nobottommargin dark">
					...
					<p>Con los ojos puestos en el futuro, con los diferentes actores que intervinienen en el escenario de la "Economía del Mar", PROIT Technologies y el Grupo COMPTA proyecta su estrategia a medio-largo plazo, basándose en el modelo de desarrollo compuesto por cuatro ejes estratégicos: "Aquatropolis Intelligent Sistema de Gestión del Sistema para las Acuíferas ", Blue Smart Governance", "Blue Transports & Logistics" y "Blue Resources Exploitation"</p>
					
					<p>Aquatropolis Intelligent Management System for Sustainable Aquacultures - Engloba las principales innovaciones tecnológicas de los campos de automatización, control y tecnología de la información, aprovechando el potencial de Internet de las cosas (IoT), de los sistemas informáticos "fog" en la "nube" (SaaS) hacia el incremento de la eficiencia productiva y la sostenibilidad de la producción acuícola multitrófica en la cuenca del Atlántico.</p>
					
					<p>Blue Smart Governance - Responde a los desafíos de empresas públicas y privadas en la gobernanza, valorización de los mares, océanos y regiones costeras. Capacitándolos con herramientas para la gestión y promoción inteligente de los recursos marinos y de las actividades económicas de sus mares..</p>
					
					<p>Blue Transports & Logistics - Apoyamos las administraciones portuarias, los operadores de terminales y las compañías de navegación, enfrascándonos a soluciones para la facilitación administrativa, el aumento de la productividad y la gestión inteligente del impacto ambiental y la eficiencia energética.</p>
					
					<p>Blue Resources Exploitation - Contribuimos a la prosperidad de la "Fila del Pescado" dotando a acuicultores, industria de la conservación, transformación y procesamiento del pescado contribuyendo a la explotación sostenible de los recursos marinos y gestión inteligente e integrada de las diferentes actividades económicas.</p>
				...
				<div class="col_half col_last topmargin nobottommargin">
					...
					<img src="<?php echo assets_url(); ?>images/contenido/mar-2.png" alt="Macbook Video Underlay" data-animate="fadeInRightBig">
