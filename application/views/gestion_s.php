		...
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?php echo assets_url(); ?>images/about/parallax.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">estión de Servicios</li>
				</ol>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="heading-block bottommargin-sm">
								<h3>Gestión global de servicios de TI, optimización y valorización de activos.</h3>
							</div>
						</div>
			...
			<div class="container clearfix">
				...
				<div class="col_half col_last topmargin-sm bottommargin-lg col_last">
					...
					<ul class="iconlist iconlist-large iconlist-color">
						<li><i class="icon-ok-sign"></i> Análisis As-Is e Informes de Gap Analysis</li>
						<li><i class="icon-ok-sign"></i> Costeo de Servicios de TI</li>
						<li><i class="icon-ok-sign"></i> Gestión de incidentes y solicitudes de servicio</li>
						<li><i class="icon-ok-sign"></i> Mantenimiento Preventivo y Predictivo (con IOT)</li>
						<li><i class="icon-ok-sign"></i> Gestión controlada de cambios</li>
						<li><i class="icon-ok-sign"></i> Servicios Gestionados</li>
						<li><i class="icon-ok-sign"></i> Gestión y Operación de IT</li>
						<li><i class="icon-ok-sign"></i> Modelos de Gobierno</li>
						<li><i class="icon-ok-sign"></i> Gestión de Servicios</li>
						<li><i class="icon-ok-sign"></i> Procesos ITIL, ISO20000 y COBIT</li>
						<li><i class="icon-ok-sign"></i> Análisis As-Is y Informes de Gap Analysis</li>
					</ul>

					<p>El panorama de las TI es cada vez más complejo, virtualizado, distribuido y diversificado. La velocidad del cambio impulsada por Cloud, Mobile y Social es desafiante.</p>
					
					<p>Si sumamos a esta realidad el aumento del número de usuarios no técnicos que accede a los servicios de TI y la reorganización para realidades de Servicios Compartidos, obtenemos equipos de TI sobrecargados, a veces desarticulados y con innumerables soluciones y procesos no integrados para soportar.</p>
		...
		<section id="page-title" class="page-title-dark">
			<div class="container clearfix">
				<div class="col_half topmargin nobottommargin dark">
					<div class="heading-block topmargin">
						<h3>¡Tenemos las herramientas y la experiencia necesarias para ayudarle!</h3>
						<span></span>
					</div>

					<p>Añade valor, proporcionando soluciones de servicios de IT, y satisfacer las necesidades específicas de cada cliente en alineación con los más altos estándares de calidad, disponibilidad y desarrollo tecnológico de acuerdo con los requisitos de la norma de referencia ISO 20000-1: 2005,nuestra misión fundamental.</p>
					
					<p>Las soluciones de gestión de servicios de COMPTA representan un paso revolucionario en la gestión global de servicios de TI, optimizando y valorando los activos de TI, alineados con la gestión del ciclo de vida con las necesidades y la evolución de su negocio.</p>
					
					<p>PROIT Technologies en alianza con COMPTA cuenta con un equipo de ITSM certificado en ITIL V3 e ISO20000, con amplia experiencia en implementaciones de modelos, procesos y soluciones de gestión de servicios de IT en los principales mercados: banca, transportes, telecomunicaciones, sector público, utilidades, salud, distribución alimentaria, gestión aeroportuaria.
¡Estamos enfocados en la solución!</p>
