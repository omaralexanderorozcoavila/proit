...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?php echo assets_url(); ?>images/about/parallax.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">
			...
			<div class="container clearfix">
				<h1>Outsourcing Global</h1>
				<span></span>
				<ol class="breadcrumb">
					<li><a href="#">Inicio</a></li>
					<li><a href="#">Soluciones</a></li>
					<li class="active">Outsourcing Global</li>
				</ol>
			</div>
		...
		<section id="content">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="heading-block bottommargin-sm">
								<h3>La utilización de la tecnología en su empresa no tiene que ser un proceso complejo, que consume múltiples recursos!</h3>
							</div>
						</div>
			...
			<div class="container clearfix">
				...
				<div class="col_half col_last topmargin-sm bottommargin-lg col_last">
					...
					<p>Con nuestro servicio, dispone de un punto de contacto único, un servicio sólo para usted, que le entrega una solución completa de acuerdo con los niveles de servicio ("SLA") que mejor sirven a su actividad y que incluye todos sus componentes De TI: de las Infraestructuras y Seguridad a las Aplicaciones de Productividad y de Negocio.</p>
					
					<p>Trabajamos de acuerdo con las mejores prácticas internacionales (ITIL, COBIT, ISO 20000, 27001, 22301 y otras) y garantizamos la adaptación facilitada a la nueva legislación y reglamentación, en particular al nuevo Reglamento General de Protección de Datos personales (RGPD, o GDPR en inglés).</p>
					
					<p>Realizamos dichas actividades por un valor fijo mensual, que no tenemos dudas será potencialmente inferior a la suma de todos los costos de TI que su organización soporta actualmente.</p>
		...
		<section id="page-title" class="page-title-dark">
			<div class="container clearfix">
				<div class="col_half topmargin nobottommargin dark">
					...
					<p>El servicio Bee2Customer 360º retira la complejidad a la tecnología, simplificando procesos y garantizando un único punto clave, para que todo el potencial de su actividad sea desbloqueada.</p>
					
					<p>Gane tiempo para su negocio y se concentre en lo que es realmente importante: ¡El crecimiento de su actividad!</p>
