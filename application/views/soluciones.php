...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?php echo assets_url(); ?>images/about/parallax.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">
			...
			<div class="container clearfix">
				<h1>Soluciones de Negocio</h1>
				<span></span>
				<ol class="breadcrumb">
					<li><a href="#">Inicio</a></li>
					<li><a href="#">Soluciones</a></li>
					<li class="active">Soluciones de Negocio</li>
				</ol>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="heading-block bottommargin-sm">
								<h3>¡Soluciones Innovadoras para Conquistar, Retener y Fidelizar Clientes!</h3>
							</div>
						</div>
			...
			<div class="container clearfix">
				...
				<div class="col_half col_last topmargin-sm bottommargin-lg col_last">
					...
					<ul class="iconlist iconlist-large iconlist-color">
						<li><i class="icon-ok-sign"></i> Gestión de RH</li>
						<li><i class="icon-ok-sign"></i> Gestión financiera</li>
						<li><i class="icon-ok-sign"></i> Gestión de ventas</li>
						<li><i class="icon-ok-sign"></i> Gestión de Marketing</li>
						<li><i class="icon-ok-sign"></i> Gestión de Producción</li>
						<li><i class="icon-ok-sign"></i> Logística</li>
						<li><i class="icon-ok-sign"></i> Gestión de Calidad</li>
					</ul>

					<p>La actividad de las empresas, los desafíos planteados por el mercado y los clientes implican respuestas integrales y efectivas. El tradicional sistema ERP ha evolucionado, pudiendo ser, la base y fuente de información para otros sistemas, conformadopor canales digitales que van más allá de la simple gestión corriente. Por esta razón, nuestra respuesta en términos de soluciones de negocio se encuentra especialmente verticalizada para responder a este desafío: Conquistar, Retener y Fidelizar Clientes.</p>
					
					<p>De forma integral, las infraestructuras en los nuevos canales digitales, muestran soluciones de negocios proporcionando una visión clara de su actividad y permiten una respuesta en tiempo real, en todos los canales de interacción a su disposición.</p>
			...
			<div class="container clearfix">
				<div class="col_half topmargin nobottommargin dark">
					<div class="heading-block topmargin">
						...
						<span>Tenemos soluciones y procesos para optimizar el viaje de sus clientes.</span>
					</div>

					<p>Nuestra mentalidad es apoyada por el conjunto de herramientas que nos da una nueva y poderosa manera de encontrar soluciones, desbloqueando el potencial de los recursos humanos de las empresas.</p>
					
					<p>A diferencia del pensamiento analítico, este es un proceso creativo basado en torno a la edificación de ideas y creatividad. Vamos más allá de las herramientas.</p>
