		...
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?php echo assets_url(); ?>images/about/parallax.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">
			...
			<div class="container clearfix">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Infraestructuras</li>
				</ol>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="heading-block bottommargin-sm">
								<h3>TIRE EL MÁXIMO PARTIDO DE SUS INFRAESTRUCTURAS</h3>
							</div>
						</div>
			...
			<div class="container clearfix">
				...
				<div class="col_half col_last topmargin-sm bottommargin-lg col_last">
					...
					<ul class="iconlist iconlist-large iconlist-color">
						<li><i class="icon-ok-sign"></i> Virtualización del Puesto de trabajo</li>
						<li><i class="icon-ok-sign"></i> Disaster Recovery</li>
						<li><i class="icon-ok-sign"></i> Salvaguarda de los datos</li>
						<li><i class="icon-ok-sign"></i> Infraestructuras</li>
						<li><i class="icon-ok-sign"></i> Nube</li>
						<li><i class="icon-ok-sign"></i> Data Center</li>
						<li><i class="icon-ok-sign"></i> Virtualización Data Center</li>
					</ul>
				
					<p>La base de la gran mayoría de los negocios exitosos es una infraestructura segura de Tecnologías de la Información. Esta base debe ser pensada para ser flexible, adaptarse a las necesidades de negocio y acompañar todos los desafíos.</p>
					
					<p>La inversión en infraestructuras y seguridad debe considerarse como estructurante, por lo que es importante mantener un enfoque 360º de las infraestructuras de IT.</p>
					
					<p>El principal objetivo es la actuación como un one stop partner. PROIT Technologies en alianza con COMPTA tiene los equipos, proyectos y la experiencia necesaria para elevar su negocio a otro nivel.</p>
			...
			<div class="container clearfix">
				<div class="col_half topmargin nobottommargin dark">
					<div class="heading-block topmargin">
						...
						<span>¿Está preparado para la digitalización de su negocio? ¿En qué etapa está? ¿Están sus datos seguros y su infraestructura para responder de acuerdo con las necesidades de sus usuarios y clientes?</span>
					</div>					

					<p>Desde el puesto de trabajo y la virtualización hasta el centro de datos y la seguridad integral de su infraestructura, tenemos la solución ideal para usted.</p>
					
					<p>Estas son algunas áreas para las que podemos encontrar la respuesta que mejor satisfaga sus necesidades.</p>
					
					<p>Tenemos una amplia experiencia en esta ámbito con asociaciones ya establecidas con los líderes mundiales, junto con los más altos grados de certificación.</p>
					
					<p>Desde el puesto de trabajo, la virtualización hasta el centro de datos y la seguridad integral de su infraestructura, tenemos la solución ideal para usted.</p>
