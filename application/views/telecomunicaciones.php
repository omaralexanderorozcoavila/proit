...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?php echo assets_url(); ?>images/banner/banner-telecomunicacoes.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">
		...
		<section id="content">
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="heading-block bottommargin-sm">
								<h3>El sector de las telecomunicaciones es uno de los hilos conductores para el desarrollo de las sociedades modernas</h3>
							</div>

							<p class="nobottommargin">Hemos participado activamente en el desarrollo de este sector en Portugal, prestando servicios e implementando soluciones de última generación en los principales operadores de telecomunicaciones y empresas nacionales.</p>
						</div>
			...
			<div class="container clearfix">
				...
				<div class="col_half topmargin-sm bottommargin">
					<img data-animate="fadeInLeftBig" src="<?php echo assets_url(); ?>images/contenido/telecomunicacoes-1.png" alt="Imac">
				</div>

				<div class="col_half col_last topmargin-sm bottommargin-lg col_last">

					<div class="heading-block topmargin">
						<h2>TENNEMOS VISIÓN Y EXPERIENCIA</h2>
						<span>En conjunto, podemos desarrollar su actividad con estas nuevas herramientas digitales, presentes en el siglo XXI.</span>
					</div>

					<p>A estos servicios añadimos nuestra capacidad de integración y desarrollo de soluciones de última generación en las áreas de: Network Security, Content Security, Perimeter Defense, NAC, VPN / Remote Access, IT Infrastructures, VOIP, Session Border Controller, Switching, Routing, Call Centros distribuidos e IP Centrex.</p>
					
					<p>Prestamos un conjunto avanzado de innovadores servicios que abarcan gran parte de las necesidades de TI que este sector pueda tener. Póngase en contacto con nosotros y conozca cómo podemos integrar en su empresa ventajas para su negocio.</p>
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" style="background-color:'#ffffff' !important;">
