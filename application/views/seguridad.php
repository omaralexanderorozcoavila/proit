					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="heading-block bottommargin-sm">
								<h3>DETENGASE Y RESPONDA A LAS AMENAZAS DE SEGURIDAD DEL DIA-A-DÍA</h3>
							</div>
						</div>
			...
			<div class="container clearfix">
				...
				<div class="col_half col_last topmargin-sm bottommargin-lg col_last">
					...
					<ul class="iconlist iconlist-large iconlist-color">
						<li><i class="icon-ok-sign"></i> Gestión de Seguridad</li>
						<li><i class="icon-ok-sign"></i> Seguridad de red y de aplicaciones</li>
						<li><i class="icon-ok-sign"></i> Gestión de identidades</li>
						<li><i class="icon-ok-sign"></i> Security Operations Center</li>
						<li><i class="icon-ok-sign"></i> Network Operations Center</li>
						<li><i class="icon-ok-sign"></i> Video Vigilancia</li>
						<li><i class="icon-ok-sign"></i> Seguridad periférica y biométrica</li>
					</ul>

					<p>En la sociedad actual en el que el flujo de información y el conocimiento constituyen los principales activos de una empresa, es imperativo que la seguridad y protección de estos activos se dirijan a todos los niveles de la organización; de forma más profunda y se utilicen las prácticas eficaces para garantizar La fiabilidad y la disponibilidad de dicho asunto.</p>
					
					<p>A medida que las empresas generan información, la almacenan y distribuyen, como forma más eficiente de conducir su actividad, aumentan los riesgos a qué información está expuesta, incluso, en el caso de que la información caiga en manos equivocadas, esté disponible o sea corrompida, constituida por una amenaza para la organización.</p>
			...
			<div class="container clearfix">
				<div class="col_half topmargin nobottommargin dark">
					<div class="heading-block topmargin">
						...
						<span>La seguridad de la información no es un problema meramente técnico de la esfera de los responsables de los sistemas de información, sino un desafío que implica la conformación de dicha gestión y a su vez toda la organización.</span>
					</div>					

					<p>PROIT Technologies en alianza con COMPTA, ofrecen un amplio conjunto de servicios y plataformas utilizables en los diferentes ámbitos relacionados con la seguridad de la información que complementados, constituyen soluciones cuyas funcionalidades garantizan la correcta protección y la disponibilidad de la información necesaria para el funcionamiento y desarrollo de las organizaciones donde se aplican.</p>
					
					<p>Este conjunto de servicios se complementa con la utilización de herramientas de análisis e informes para verificar las necesidades de la organización en términos de seguridad de información y definir las medidas necesarias para alcanzar los objetivos que se plantean.</p>
					
					<p>Una adecuada gestión del riesgo, la definición de procedimientos y de políticas de seguridad, la implementación de una arquitectura de sistemas adecuada y el uso de plataformas de seguridad específicas complementadas con la correcta monitorización y actualización, son fundamentales para garantizar una protección eficiente de la información generada y puesta a disposición de la organización.</p>
