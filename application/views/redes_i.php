...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('<?php echo assets_url(); ?>images/about/parallax.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">
			...
			<div class="container clearfix">
				<h1>Redes Inteligentes</h1>
				<span></span>
				<ol class="breadcrumb">
					<li><a href="#">Inicio</a></li>
					<li><a href="#">Soluciones</a></li>
					<li class="active">Redes Inteligentes</li>
				</ol>
			</div>
					...
					<div class="row">
						...
						<div class="col-md-9">
							<div class="heading-block bottommargin-sm">
								<h3>Redes de nueva generación, inteligentes, seguras, resistentes.</h3>
							</div>
						</div>
			...
			<div class="container clearfix">
				...
				<div class="col_half col_last topmargin-sm bottommargin-lg col_last">
					...
					<ul class="iconlist iconlist-large iconlist-color">
						<li><i class="icon-ok-sign"></i> Application Networking Services</li>
						<li><i class="icon-ok-sign"></i> Network Management & Automation</li>
						<li><i class="icon-ok-sign"></i> Seguridad</li>
						<li><i class="icon-ok-sign"></i> Routers & Switches</li>
						<li><i class="icon-ok-sign"></i> Redes inalámbricas</li>
						<li><i class="icon-ok-sign"></i> Collaboration</li>
						<li><i class="icon-ok-sign"></i> Telepresence and video Voice</li>
						<li><i class="icon-ok-sign"></i> Unified Communications</li>
						<li><i class="icon-ok-sign"></i> Webex</li>
						<li><i class="icon-ok-sign"></i> Almacenamiento de redes</li>
						<li><i class="icon-ok-sign"></i> Borderless Networking</li>
					</ul>

					<p>Las redes inteligentes o redes de nueva generación, son pilares fundamentales de las sociedades modernas.</p>
					
					<p>Tanto si se trata de redes empresariales o de operadores, son sistemas complejos que requieren un enfoque cuidadoso, minucioso y profesional.</p>
					
					<p>A lo largo de los años hemos desarrollado alianzas con los principales fabricantes mundiales en el área del Networking lo que nos ha permitido diseñar, implementar y mantener múltiples redes, en diversas tipologías y dimensiones. Trabajamos con las redes más complejas hasta las más dispersas, aseguramos altos niveles de servicio y tiempos de respuesta, siempre de acuerdo con la criticidad del negocio.</p>
		...
		<section id="page-title" class="page-title-dark">
			<div class="container clearfix">
				<div class="col_half topmargin nobottommargin dark">
					...
					<p>Tenemos una aproximación multidisciplinaria, la capacidad de pensar las redes en sus más diversos componentes, salvaguardando la disponibilidad, la seguridad y la resilencia.</p>
					
					<p>Vemos la red como un todo y disponemos de un amplio conjunto de innovadoras soluciones, productos y servicios que permiten las mejores respuestas.</p>
		...
		<section id="page-title" class="page-title-dark">
			<a class="button button-full center tright footer-stick">
				<div class="container clearfix">
					¡Tenemos la respuesta que buscas! ¿Necesita más información? <strong>Contáctenos</strong> <i class="icon-caret-right" style="top:4px;"></i>
				</div>
			</a>
		</section><!-- #page-title end -->
